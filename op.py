...
while True:
    ...
    if len(contours) > 0:
        ...
        cv2.putText(frame, "Center: x=" + str(cx) + ", y=" + str(cy), (5, 15), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 0))
        ...
        if cx < width / 2:
            ...
            rightCounter += 1
        cv2.putText(frame, "Left: " + str(leftCounter), (5, 45), cv2.FONT_HERSHEY_PLAIN, 1,
                    (0, 0, 255) if left else (0, 0, 0))
        cv2.putText(frame, "Right: " + str(rightCounter), (5, 60), cv2.FONT_HERSHEY_PLAIN, 1,
